...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = '/resource/plugins/pdfjs/web/images/';
  PDFJS.workerSrc = '/resource/plugins/pdfjs/build/pdf.worker.js';
  PDFJS.cMapUrl = '/resource/plugins/pdfjs/web/cmaps/';
